      ...
      @if (showAdminPanel) {
        <section>
          ...
          <div class="flex flex-wrap gap-3">
            <button mat-stroked-button color="primary" (click)="updateMatchStatus('live')">
              <mat-icon>play_circle</mat-icon> Start Match
            </button>
            <button mat-stroked-button (click)="updateMatchStatus('finished')">
              <mat-icon>sports_score</mat-icon> End Match
            </button>
            <button mat-stroked-button color="warn" (click)="updateMatchStatus('cancelled')">
              <mat-icon>cancel</mat-icon> Cancel Match
            </button>
            <button mat-stroked-button (click)="updateMatchStatus('postponed')">
              <mat-icon>schedule</mat-icon> Postpone Match
            </button>
            <button mat-stroked-button color="accent" (click)="clearAllEvents()">
          ...
          <mat-expansion-panel>
            ...
            <div class="py-4">
              ...
              <div class="mb-4 flex items-center justify-between">
                ...
                <button mat-stroked-button color="primary" (click)="addPlayer('home')">
          ...
          <mat-expansion-panel>
            ...
            <div class="py-4">
              ...
              <div class="mb-4 flex items-center justify-between">
                ...
                <button mat-stroked-button color="primary" (click)="addPlayer('away')">
                  <mat-icon>add</mat-icon> Add Player
                </button>
              </div>
        ...
        <div class="timer-card rounded-xl p-4">
          ...
          @if (isEditingTime) {
            <div class="time-edit-container">
              ...
              <div class="time-edit-actions">
                <button mat-icon-button color="primary" (click)="saveTime()" class="h-8! w-8!">
                  <mat-icon class="text-lg!">check</mat-icon>
                </button>
                <button mat-icon-button (click)="cancelTimeEdit()" class="h-8! w-8!">
                  <mat-icon class="text-lg!">close</mat-icon>
                </button>
              </div>
            </div>
          ...
          @if (matchInfo().status === 'live' || matchInfo().status === 'scheduled') {
            <div class="timer-controls">
              @if (isRunning()) {
                <button mat-icon-button (click)="pauseTimer()">
                  <mat-icon>pause</mat-icon>
                </button>
              } @else {
                <button mat-mini-fab color="primary" (click)="startTimer()">
